...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Acme Dashboard design token palette — **blue / indigo** theme. Swatches read directly from CSS variables.",
      },
    },
  },
} satisfies Meta
...
export const Palette: Story = {
  render: () => (
    <div className="space-y-10 p-2">
      <Section title="Brand — Blue / Indigo">
...
export const BrandColors: Story = {
  render: () => (
    <div className="flex flex-wrap gap-4">
      {[
        { bg: "--primary", fg: "--primary-foreground", label: "Primary · Blue-600" },
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-sm">Acme blue surface depth</p>
        </div>
      </div>
    </div>
  ),
